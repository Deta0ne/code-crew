...
export const applicationSchema = z.object({
    ...
    what_they_bring: z.string().min(20, 'Please describe what you bring (minimum 20 characters)').or(z.literal('')).optional(),
    what_they_want_to_learn: z.string().min(20, 'Please describe what you want to learn (minimum 20 characters)').or(z.literal('')).optional(),
